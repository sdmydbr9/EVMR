-- Demo data for PetSphere system
...
VALUES ('PetSphere Demo Clinic', '123 Veterinary Lane, Demo City', '555-123-4567', 'demo-clinic@petsphere.com')
...
VALUES 
  ('Pet Parent Demo', 'petparent_demo@petsphere.com', '$2a$10$K4iYhOXBl2yBWq1zs7T7F.dVlxuaoq5TA/zbL6HJGrnFdyQNgV4Y2', 'client', '{"phone": "555-111-2222", "address": "456 Pet Owner St, Demo City"}'),
  ('Veterinarian Demo', 'vet_demo@petsphere.com', '$2a$10$K4iYhOXBl2yBWq1zs7T7F.dVlxuaoq5TA/zbL6HJGrnFdyQNgV4Y2', 'veterinarian', '{"unique_id": "VET12345", "specialization": "Small Animals", "license_number": "DVM-12345", "clinic_id": 1}'),
  ('Admin Demo', 'org_demo@petsphere.com', '$2a$10$K4iYhOXBl2yBWq1zs7T7F.dVlxuaoq5TA/zbL6HJGrnFdyQNgV4Y2', 'admin', '{"organisation_id": "ORG12345", "clinic_id": 1, "permissions": ["manage_users", "manage_clinics", "view_reports"]}')
