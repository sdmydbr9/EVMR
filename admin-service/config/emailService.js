...
const sendApprovalEmail = async (user) => {
  ...
  const text = `
    ...
    You can now log in to the system at http://localhost:3786 with your credentials.
    ...
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="padding: 20px; border: 1px solid #e0e0e0; border-top: none;">
        ...
        <div style="background-color: #f5f5f5; border-left: 4px solid #4CAF50; padding: 15px; margin: 20px 0;">
          <p style="margin: 0;">You can now log in to the system at <a href="http://localhost:3786">http://localhost:3786</a> with your credentials.</p>
        </div>
